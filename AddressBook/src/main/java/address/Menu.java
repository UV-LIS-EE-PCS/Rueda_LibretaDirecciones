...
public class Menu {
    ...
    private void loadEntries(Scanner scanner) {
        ...
        try {
            String resourcePath = "src/main/resources/" + fileName;  // Ajusta la ruta según sea necesario
    ...
    /**
     * Lista todas las entradas de la libreta de direcciones ordenadas alfabéticamente por el primer nombre.
     */
